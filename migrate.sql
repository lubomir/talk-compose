...
ALTER TABLE "compose" ADD COLUMN IF NOT EXISTS "type" VARCHAR;
ALTER TABLE "compose" ADD COLUMN IF NOT EXISTS "respin" INT8;

UPDATE "compose" SET "release"=rtrim(rtrim(rtrim(rtrim("compose_id", '0123456789ntci.'), '-'), '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'), '-');
...
UPDATE "compose" SET "type"=rtrim(ltrim(reverse(split_part(reverse("compose_id"), '-', 1)), '0123456789.'), '0123456789.');
...
ALTER TABLE "compose" ALTER COLUMN "type" SET NOT NULL;
